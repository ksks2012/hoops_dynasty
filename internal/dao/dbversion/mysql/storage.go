...
import (
	...
	interfaces "github.com/hoops_dynasty/interfaces"
)
...
const defaultRoundRobinLocationName = "db-tab-1"
const mysqlDialerContextName = "db-conn"

const metaStoreTableName = "db.meta"
